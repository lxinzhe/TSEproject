        ...
        <div class="row">
            ...
            <div class="col-md-3 col-lg-2 sidebar p-3">
                ...
                <nav class="nav flex-column">
                    ...
                    <a class="nav-link active" href="cpd_categories.php"><i class="fas fa-tags me-2"></i>CPD Categories</a>
                    <a class="nav-link" href="cpd_progress.php"><i class="fas fa-chart-line me-2"></i>CPD Progress</a>
