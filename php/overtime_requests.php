...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "UPDATE overtime_requests SET status = ?, reviewed_by = ?, reviewed_at = NOW() WHERE id = ?";
...
$sql = "SELECT ot.*, e.name as employee_name 
...
<head>
    ...
    <title>Overtime Requests - Admin Panel</title>
        ...
        <div class="row">
            ...
            <div class="col-md-3 col-lg-2 sidebar p-3">
                ...
                <nav class="nav flex-column">
                    ...
                    <a class="nav-link active" href="overtime_requests.php">
            ...
            <div class="col-md-9 col-lg-10 main-content">
                ...
                <div class="header-section">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h2 class="mb-1">
                                <i class="fas fa-clock me-2"></i>Overtime Requests Management
                            </h2>
                            <p class="text-muted mb-0">Review and approve/reject employee overtime requests</p>
                        </div>
                        <div class="text-end">
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0">
                            <i class="fas fa-list me-2"></i>All Overtime Requests
                        </h5>
                    </div>
                    <div class="card-body">
                                    ...
                                    <tbody>
                                        <?php while ($row = $result->fetch_assoc()): ?>
                                            ...
                                            <tr>
                                                ...
                                                <td><?= date('M j, Y', strtotime($row['ot_date'])) ?></td>
                                                <td>
                                                    <strong><?= date('g:i A', strtotime($row['start_time'])) ?></strong>
                                                    <br>to
                                                    <br><strong><?= date('g:i A', strtotime($row['end_time'])) ?></strong>
                                                </td>
                                                <td>
                                                    <span class="badge hours-badge">
                                                        <?= $row['total_hours'] ?> hrs
                                                    </span>
                                                </td>
                                                <td>
                        ...
                        <?php else: ?>
                            <div class="text-center py-5">
                                ...
                                <p class="text-muted">No employee overtime requests have been submitted yet.</p>
                            </div>
                        <?php endif; ?>
                    </div>
                </div>
